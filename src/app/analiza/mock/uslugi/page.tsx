...
import { MOCK_ANALYSIS_USLUGI, MOCK_POPUP_DATA_USLUGI } from "@/lib/mockData";
...
export default function MockUslugPage() {
  return (
      ...
      <div className="max-w-[1280px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-7 space-y-8">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-white/35 text-sm" style={{ fontFamily: "Satoshi, sans-serif" }}>
            Demo — wariant: agencja / usługi (esoy.pl)
          </p>
        </div>
        <MockAnalysisShell state={MOCK_ANALYSIS_USLUGI} popupData={MOCK_POPUP_DATA_USLUGI} />
      </div>
    </main>
  );
}
